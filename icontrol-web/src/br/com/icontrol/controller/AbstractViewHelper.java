...
public abstract class AbstractViewHelper<T extends Entidade> implements Serializable{
	...
	protected static ResourceBundle bundle = ResourceBundle.getBundle("br.com.icontrol.messages.messages");
	...
	public void gravarLog(String descricao,int tipo){
		...
		log.setUsuario(FacesUtil.recuperarUsuarioSessao());
